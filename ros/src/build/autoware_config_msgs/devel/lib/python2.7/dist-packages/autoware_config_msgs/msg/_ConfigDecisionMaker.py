...
class ConfigDecisionMaker(genpy.Message):
  _md5sum = "3b8bfb82d204c9a48da41330c8f07b1b"
...
string frame_id
"""
  __slots__ = ['header','auto_mission_reload','auto_engage','auto_mission_change','use_fms','disuse_vector_map','num_of_steer_behind','change_threshold_dist','change_threshold_angle','goal_threshold_dist','goal_threshold_vel']
  _slot_types = ['std_msgs/Header','bool','bool','bool','bool','bool','uint32','float64','float64','float64','float64']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,auto_mission_reload,auto_engage,auto_mission_change,use_fms,disuse_vector_map,num_of_steer_behind,change_threshold_dist,change_threshold_angle,goal_threshold_dist,goal_threshold_vel
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_5BI4d().pack(_x.auto_mission_reload, _x.auto_engage, _x.auto_mission_change, _x.use_fms, _x.disuse_vector_map, _x.num_of_steer_behind, _x.change_threshold_dist, _x.change_threshold_angle, _x.goal_threshold_dist, _x.goal_threshold_vel))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.auto_mission_reload, _x.auto_engage, _x.auto_mission_change, _x.use_fms, _x.disuse_vector_map, _x.num_of_steer_behind, _x.change_threshold_dist, _x.change_threshold_angle, _x.goal_threshold_dist, _x.goal_threshold_vel,) = _get_struct_5BI4d().unpack(str[start:end])
...
def _get_struct_3I():
    ...
    return _struct_3I
_struct_5BI4d = None
def _get_struct_5BI4d():
    global _struct_5BI4d
    if _struct_5BI4d is None:
        _struct_5BI4d = struct.Struct("<5BI4d")
    return _struct_5BI4d
