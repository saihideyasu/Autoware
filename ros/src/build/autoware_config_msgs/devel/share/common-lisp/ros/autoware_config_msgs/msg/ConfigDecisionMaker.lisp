...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ConfigDecisionMaker>)))
  ...
  "3b8bfb82d204c9a48da41330c8f07b1b")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ConfigDecisionMaker)))
  "Returns md5sum for a message object of type 'ConfigDecisionMaker"
  "3b8bfb82d204c9a48da41330c8f07b1b")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ConfigDecisionMaker>)))
  ...
  (cl:format cl:nil "Header header~%bool auto_mission_reload~%bool auto_engage~%bool auto_mission_change~%bool use_fms~%bool disuse_vector_map~%uint32 num_of_steer_behind~%float64 change_threshold_dist~%float64 change_threshold_angle~%float64 goal_threshold_dist~%float64 goal_threshold_vel~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ConfigDecisionMaker)))
  "Returns full string definition for message of type 'ConfigDecisionMaker"
  (cl:format cl:nil "Header header~%bool auto_mission_reload~%bool auto_engage~%bool auto_mission_change~%bool use_fms~%bool disuse_vector_map~%uint32 num_of_steer_behind~%float64 change_threshold_dist~%float64 change_threshold_angle~%float64 goal_threshold_dist~%float64 goal_threshold_vel~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
