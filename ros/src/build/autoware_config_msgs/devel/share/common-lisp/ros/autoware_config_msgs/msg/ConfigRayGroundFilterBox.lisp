...
;//! \htmlinclude ConfigRayGroundFilterBox.msg.html

(cl:defclass <ConfigRayGroundFilterBox> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
...
(cl:defclass ConfigRayGroundFilterBox (<ConfigRayGroundFilterBox>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <ConfigRayGroundFilterBox>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'ConfigRayGroundFilterBox)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name autoware_config_msgs-msg:<ConfigRayGroundFilterBox> is deprecated: use autoware_config_msgs-msg:ConfigRayGroundFilterBox instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <ConfigRayGroundFilterBox>))
...
(cl:defmethod sensor_height-val ((m <ConfigRayGroundFilterBox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_config_msgs-msg:sensor_height-val is deprecated.  Use autoware_config_msgs-msg:sensor_height instead.")
  (sensor_height m))

(cl:ensure-generic-function 'clipping_height-val :lambda-list '(m))
(cl:defmethod clipping_height-val ((m <ConfigRayGroundFilterBox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_config_msgs-msg:clipping_height-val is deprecated.  Use autoware_config_msgs-msg:clipping_height instead.")
  (clipping_height m))

(cl:ensure-generic-function 'min_point_distance-val :lambda-list '(m))
(cl:defmethod min_point_distance-val ((m <ConfigRayGroundFilterBox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_config_msgs-msg:min_point_distance-val is deprecated.  Use autoware_config_msgs-msg:min_point_distance instead.")
  (min_point_distance m))

(cl:ensure-generic-function 'radial_divider_angle-val :lambda-list '(m))
(cl:defmethod radial_divider_angle-val ((m <ConfigRayGroundFilterBox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_config_msgs-msg:radial_divider_angle-val is deprecated.  Use autoware_config_msgs-msg:radial_divider_angle instead.")
  (radial_divider_angle m))

(cl:ensure-generic-function 'concentric_divider_distance-val :lambda-list '(m))
(cl:defmethod concentric_divider_distance-val ((m <ConfigRayGroundFilterBox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_config_msgs-msg:concentric_divider_distance-val is deprecated.  Use autoware_config_msgs-msg:concentric_divider_distance instead.")
  (concentric_divider_distance m))

(cl:ensure-generic-function 'local_max_slope-val :lambda-list '(m))
(cl:defmethod local_max_slope-val ((m <ConfigRayGroundFilterBox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_config_msgs-msg:local_max_slope-val is deprecated.  Use autoware_config_msgs-msg:local_max_slope instead.")
  (local_max_slope m))

(cl:ensure-generic-function 'general_max_slope-val :lambda-list '(m))
(cl:defmethod general_max_slope-val ((m <ConfigRayGroundFilterBox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_config_msgs-msg:general_max_slope-val is deprecated.  Use autoware_config_msgs-msg:general_max_slope instead.")
  (general_max_slope m))

(cl:ensure-generic-function 'min_height_threshold-val :lambda-list '(m))
(cl:defmethod min_height_threshold-val ((m <ConfigRayGroundFilterBox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_config_msgs-msg:min_height_threshold-val is deprecated.  Use autoware_config_msgs-msg:min_height_threshold instead.")
  (min_height_threshold m))

(cl:ensure-generic-function 'reclass_distance_threshold-val :lambda-list '(m))
(cl:defmethod reclass_distance_threshold-val ((m <ConfigRayGroundFilterBox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_config_msgs-msg:reclass_distance_threshold-val is deprecated.  Use autoware_config_msgs-msg:reclass_distance_threshold instead.")
  (reclass_distance_threshold m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <ConfigRayGroundFilterBox>) ostream)
  "Serializes a message object of type '<ConfigRayGroundFilterBox>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ConfigRayGroundFilterBox>) istream)
  "Deserializes a message object of type '<ConfigRayGroundFilterBox>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ConfigRayGroundFilterBox>)))
  "Returns string type for a message object of type '<ConfigRayGroundFilterBox>"
  "autoware_config_msgs/ConfigRayGroundFilterBox")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ConfigRayGroundFilterBox)))
  "Returns string type for a message object of type 'ConfigRayGroundFilterBox"
  "autoware_config_msgs/ConfigRayGroundFilterBox")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ConfigRayGroundFilterBox>)))
  "Returns md5sum for a message object of type '<ConfigRayGroundFilterBox>"
  "1b9a20593709b07932fff996671d4ed6")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ConfigRayGroundFilterBox)))
  "Returns md5sum for a message object of type 'ConfigRayGroundFilterBox"
  "1b9a20593709b07932fff996671d4ed6")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ConfigRayGroundFilterBox>)))
  "Returns full string definition for message of type '<ConfigRayGroundFilterBox>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ConfigRayGroundFilterBox)))
  "Returns full string definition for message of type 'ConfigRayGroundFilterBox"
  (cl:format cl:nil "std_msgs/Header header~%~%float64  sensor_height~%float64  clipping_height~%float64  min_point_distance~%float64  radial_divider_angle~%float64  concentric_divider_distance~%float64  local_max_slope~%float64  general_max_slope~%float64  min_height_threshold~%float64  reclass_distance_threshold~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <ConfigRayGroundFilterBox>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <ConfigRayGroundFilterBox>))
  "Converts a ROS message object to a list"
  (cl:list 'ConfigRayGroundFilterBox
