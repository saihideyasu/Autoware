...
class ConfigLocalizerSwitchFusion {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.uint8(obj.fusion_select, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ConfigLocalizerSwitchFusion(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [fusion_select]
    data.fusion_select = _deserializer.uint8(buffer, bufferOffset);
    return data;
  }
  ...
  static datatype() {
    ...
    return 'autoware_config_msgs/ConfigLocalizerSwitchFusion';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '58473b5ebe9487298d7ee7dcf714d641';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ConfigLocalizerSwitchFusion(null);
...
module.exports = ConfigLocalizerSwitchFusion;
