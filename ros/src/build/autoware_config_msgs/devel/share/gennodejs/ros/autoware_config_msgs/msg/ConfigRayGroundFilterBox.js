...
class ConfigRayGroundFilterBox {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ConfigRayGroundFilterBox(null);
  ...
  static datatype() {
    ...
    return 'autoware_config_msgs/ConfigRayGroundFilterBox';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ConfigRayGroundFilterBox(null);
...
module.exports = ConfigRayGroundFilterBox;
