...
struct ImageObjTracked_
{
  ...
  _obj_id_type obj_id;
   ...
   typedef std::vector< ::autoware_msgs::ImageRectRanged_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::autoware_msgs::ImageRectRanged_<ContainerAllocator> >::other >  _rect_ranged_type;
