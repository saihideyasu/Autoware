...
class DetectedObject(genpy.Message):
  _md5sum = "5665d283da555cf9fb130dcf945cdbcc"
...
"""
  __slots__ = ['header','id','label','score','color','valid','space_frame','pose','dimensions','variance','velocity','acceleration','pointcloud','convex_hull','candidate_trajectories','pose_reliable','velocity_reliable','acceleration_reliable','image_frame','x','y','width','height','angle','roi_image','indicator_state','behavior_state','user_defined_info']
  _slot_types = ['std_msgs/Header','uint32','string','float32','std_msgs/ColorRGBA','bool','string','geometry_msgs/Pose','geometry_msgs/Vector3','geometry_msgs/Vector3','geometry_msgs/Twist','geometry_msgs/Twist','sensor_msgs/PointCloud2','geometry_msgs/PolygonStamped','autoware_msgs/LaneArray','bool','bool','bool','string','int32','int32','int32','int32','float32','sensor_msgs/Image','uint8','uint8','string[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,id,label,score,color,valid,space_frame,pose,dimensions,variance,velocity,acceleration,pointcloud,convex_hull,candidate_trajectories,pose_reliable,velocity_reliable,acceleration_reliable,image_frame,x,y,width,height,angle,roi_image,indicator_state,behavior_state,user_defined_info
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_get_struct_i().pack(self.candidate_trajectories.id))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.candidate_trajectories.id,) = _get_struct_i().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
