...
(cl:defclass <Waypoint> (roslisp-msg-protocol:ros-message)
  ((gid
   ...
   (direction
    ...
    :initform 0)
   (waypoint_param
    :reader waypoint_param
    :initarg :waypoint_param
    :type autoware_msgs-msg:WaypointParam
    :initform (cl:make-instance 'autoware_msgs-msg:WaypointParam))
   (signals
    :reader signals
    :initarg :signals
...
(cl:ensure-generic-function 'waypoint_param-val :lambda-list '(m))
(cl:defmethod waypoint_param-val ((m <Waypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:waypoint_param-val is deprecated.  Use autoware_msgs-msg:waypoint_param instead.")
  (waypoint_param m))

(cl:ensure-generic-function 'signals-val :lambda-list '(m))
(cl:defmethod signals-val ((m <Waypoint>))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Waypoint>) ostream)
  ...
  (roslisp-msg-protocol:serialize (cl:slot-value msg 'waypoint_param) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Waypoint>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'waypoint_param) istream)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Waypoint>)))
  ...
  "341d2d62ef3b96657a4679c92dc89f5e")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Waypoint)))
  "Returns md5sum for a message object of type 'Waypoint"
  "341d2d62ef3b96657a4679c92dc89f5e")
...
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <Waypoint>))
  (cl:+ 0
     ...
     4
     4
     (roslisp-msg-protocol:serialization-length (cl:slot-value msg 'waypoint_param))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <Waypoint>))
  ...
  (cl:list 'Waypoint
    ...
    (cl:cons ':waypoint_param (waypoint_param msg))
