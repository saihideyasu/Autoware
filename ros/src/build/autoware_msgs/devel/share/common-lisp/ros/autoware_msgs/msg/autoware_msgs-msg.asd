...
(defsystem "autoware_msgs-msg"
  ...
  :components ((:file "_package")
    ...
    (:file "DifferenceToWaypointDistance" :depends-on ("_package_DifferenceToWaypointDistance"))
    (:file "_package_DifferenceToWaypointDistance" :depends-on ("_package"))
    (:file "ExtractedPosition" :depends-on ("_package_ExtractedPosition"))
    (:file "_package_ExtractedPosition" :depends-on ("_package"))
    (:file "Format7Info" :depends-on ("_package_Format7Info"))
    (:file "_package_Format7Info" :depends-on ("_package"))
    (:file "GeometricRectangle" :depends-on ("_package_GeometricRectangle"))
    (:file "_package_GeometricRectangle" :depends-on ("_package"))
    (:file "GnssStandardDeviation" :depends-on ("_package_GnssStandardDeviation"))
    (:file "_package_GnssStandardDeviation" :depends-on ("_package"))
    (:file "GnssSurfaceSpeed" :depends-on ("_package_GnssSurfaceSpeed"))
    (:file "_package_GnssSurfaceSpeed" :depends-on ("_package"))
    ...
    (:file "ImuMathValue" :depends-on ("_package_ImuMathValue"))
    (:file "_package_ImuMathValue" :depends-on ("_package"))
    ...
    (:file "LiesseXZB70MParam" :depends-on ("_package_LiesseXZB70MParam"))
    (:file "_package_LiesseXZB70MParam" :depends-on ("_package"))
    (:file "LinearArray" :depends-on ("_package_LinearArray"))
    (:file "_package_LinearArray" :depends-on ("_package"))
    (:file "NDTStat" :depends-on ("_package_NDTStat"))
    (:file "_package_NDTStat" :depends-on ("_package"))
    (:file "NdtPoseAndRTKPose" :depends-on ("_package_NdtPoseAndRTKPose"))
    (:file "_package_NdtPoseAndRTKPose" :depends-on ("_package"))
    ...
    (:file "PositionChecker" :depends-on ("_package_PositionChecker"))
    (:file "_package_PositionChecker" :depends-on ("_package"))
    ...
    (:file "WaypointParam" :depends-on ("_package_WaypointParam"))
    (:file "_package_WaypointParam" :depends-on ("_package"))
