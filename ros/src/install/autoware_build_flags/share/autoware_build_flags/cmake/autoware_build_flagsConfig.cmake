...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'autoware_build_flags' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/autoware/Autoware_1.11.0_sai_edit/ros/src/install/autoware_build_flags/${idir}'.  ${_report}")
    endif()
