// Generated by gencpp from file autoware_config_msgs/ConfigCarKF.msg
// DO NOT EDIT!


#ifndef AUTOWARE_CONFIG_MSGS_MESSAGE_CONFIGCARKF_H
#define AUTOWARE_CONFIG_MSGS_MESSAGE_CONFIGCARKF_H
...
struct ConfigCarKF_
{
  ...
  typedef boost::shared_ptr< ::autoware_config_msgs::ConfigCarKF_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::autoware_config_msgs::ConfigCarKF_<ContainerAllocator> const> ConstPtr;

}; // struct ConfigCarKF_

typedef ::autoware_config_msgs::ConfigCarKF_<std::allocator<void> > ConfigCarKF;

typedef boost::shared_ptr< ::autoware_config_msgs::ConfigCarKF > ConfigCarKFPtr;
typedef boost::shared_ptr< ::autoware_config_msgs::ConfigCarKF const> ConfigCarKFConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::autoware_config_msgs::ConfigCarKF_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::autoware_config_msgs::ConfigCarKF_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::autoware_config_msgs::ConfigCarKF_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::autoware_config_msgs::ConfigCarKF_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::autoware_config_msgs::ConfigCarKF_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::autoware_config_msgs::ConfigCarKF_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::autoware_config_msgs::ConfigCarKF_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::autoware_config_msgs::ConfigCarKF_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::autoware_config_msgs::ConfigCarKF_<ContainerAllocator> >
{
  ...
  static const char* value(const ::autoware_config_msgs::ConfigCarKF_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x35fb5980cbba7f23ULL;
  static const uint64_t static_value2 = 0x7457ede929c58aa9ULL;
};

template<class ContainerAllocator>
struct DataType< ::autoware_config_msgs::ConfigCarKF_<ContainerAllocator> >
{
  static const char* value()
  {
    return "autoware_config_msgs/ConfigCarKF";
  }
...
template<class ContainerAllocator>
struct Definition< ::autoware_config_msgs::ConfigCarKF_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::autoware_config_msgs::ConfigCarKF_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::autoware_config_msgs::ConfigCarKF_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::autoware_config_msgs::ConfigCarKF_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // AUTOWARE_CONFIG_MSGS_MESSAGE_CONFIGCARKF_H
