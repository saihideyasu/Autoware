// Generated by gencpp from file autoware_config_msgs/ConfigRayGroundFilterBox.msg
// DO NOT EDIT!


#ifndef AUTOWARE_CONFIG_MSGS_MESSAGE_CONFIGRAYGROUNDFILTERBOX_H
#define AUTOWARE_CONFIG_MSGS_MESSAGE_CONFIGRAYGROUNDFILTERBOX_H
...
struct ConfigRayGroundFilterBox_
{
  typedef ConfigRayGroundFilterBox_<ContainerAllocator> Type;

  ConfigRayGroundFilterBox_()
    : header()
    , sensor_height(0.0)
    , clipping_height(0.0)
  ...
  ConfigRayGroundFilterBox_(const ContainerAllocator& _alloc)
    : header(_alloc)
    , sensor_height(0.0)
    , clipping_height(0.0)
    , min_point_distance(0.0)
  ...
  typedef boost::shared_ptr< ::autoware_config_msgs::ConfigRayGroundFilterBox_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::autoware_config_msgs::ConfigRayGroundFilterBox_<ContainerAllocator> const> ConstPtr;

}; // struct ConfigRayGroundFilterBox_

typedef ::autoware_config_msgs::ConfigRayGroundFilterBox_<std::allocator<void> > ConfigRayGroundFilterBox;

typedef boost::shared_ptr< ::autoware_config_msgs::ConfigRayGroundFilterBox > ConfigRayGroundFilterBoxPtr;
typedef boost::shared_ptr< ::autoware_config_msgs::ConfigRayGroundFilterBox const> ConfigRayGroundFilterBoxConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::autoware_config_msgs::ConfigRayGroundFilterBox_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::autoware_config_msgs::ConfigRayGroundFilterBox_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::autoware_config_msgs::ConfigRayGroundFilterBox_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::autoware_config_msgs::ConfigRayGroundFilterBox_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::autoware_config_msgs::ConfigRayGroundFilterBox_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::autoware_config_msgs::ConfigRayGroundFilterBox_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::autoware_config_msgs::ConfigRayGroundFilterBox_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::autoware_config_msgs::ConfigRayGroundFilterBox_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::autoware_config_msgs::ConfigRayGroundFilterBox_<ContainerAllocator> >
{
  ...
  static const char* value(const ::autoware_config_msgs::ConfigRayGroundFilterBox_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x1b9a20593709b079ULL;
  static const uint64_t static_value2 = 0x32fff996671d4ed6ULL;
};

template<class ContainerAllocator>
struct DataType< ::autoware_config_msgs::ConfigRayGroundFilterBox_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::autoware_config_msgs::ConfigRayGroundFilterBox_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::autoware_config_msgs::ConfigRayGroundFilterBox_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::autoware_config_msgs::ConfigRayGroundFilterBox_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::autoware_config_msgs::ConfigRayGroundFilterBox_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // AUTOWARE_CONFIG_MSGS_MESSAGE_CONFIGRAYGROUNDFILTERBOX_H
