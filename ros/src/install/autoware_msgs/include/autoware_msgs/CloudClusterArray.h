...
struct CloudClusterArray_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::autoware_msgs::CloudCluster_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::autoware_msgs::CloudCluster_<ContainerAllocator> >::other >  _clusters_type;
