...
class DifferenceToWaypointDistance {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new DifferenceToWaypointDistance(null);
  ...
  static datatype() {
    ...
    return 'autoware_msgs/DifferenceToWaypointDistance';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '22ae3b6d388334cdc987fffb0f35ae61';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new DifferenceToWaypointDistance(null);
...
module.exports = DifferenceToWaypointDistance;
