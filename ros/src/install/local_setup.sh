...
_colcon_prefix_sh_COLCON_CURRENT_PREFIX="/home/autoware/Autoware_1.11.0_sai_edit/ros/src/install"
...
_colcon_ordered_packages="$($_colcon_python_executable "$_colcon_prefix_sh_COLCON_CURRENT_PREFIX/_local_setup_util.py")"
...
for _colcon_package_name in $_colcon_ordered_packages; do
  ...
  COLCON_CURRENT_PREFIX="${_colcon_prefix_sh_COLCON_CURRENT_PREFIX}/${_colcon_package_name}"
  _colcon_prefix_sh_source_script "$COLCON_CURRENT_PREFIX/share/${_colcon_package_name}/package.sh"
done
