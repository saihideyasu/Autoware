...
RayGroundFilterBox::RayGroundFilterBox():node_handle_("~")
{
  ros::NodeHandle nh;
  ros::NodeHandle pnh("~");
...
void RayGroundFilterBox::Run()
{
  ...
  config_node_sub_ = node_handle_.subscribe("/config/ray_ground_filter", 1, &RayGroundFilterBox::update_config_params, this);
