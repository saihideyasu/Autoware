...
private:
	...
	//global params
	double vehicle_length_, vehicle_width_, vehicle_height_, vehicle_front_to_baselink_;
	...
	void update_config_params(const autoware_config_msgs::ConfigRayGroundFilterBox::ConstPtr& param);
